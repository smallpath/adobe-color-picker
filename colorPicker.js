...
function colorPicker(inputColour){
    if(!(this instanceof colorPicker))
        return new colorPicker(inputColour)
...
colorPicker.prototype.convertHsbToKulerHsb =  function(hsb){
    ...
    if(resH<30 && resH>=0){
        ...
        h = (resH-0)/(30-0)*(45-0)+0;
        
    }else if(resH<60 && resH>=30){ 
        h = (resH-30)/(60-30)*(120-45)+45;
        
    }else if(resH<120 && resH>=60){ 
        h = (resH-60)/(120-60)*(180-120)+120;
        
    }else if(resH<180 && resH>=120){ 
        h = (resH-120)/(180-120)*(220-180)+180;
        
    }else if(resH<240 && resH>=180){ 
        h = (resH-180)/(240-180)*(275-220)+220;
        
    }else if(resH<300 && resH>=240){ 
        h = (resH-240)/(300-240)*(320-275)+275;
        
    }else if(resH<360 && resH>=300){ 
        h = (resH-300)/(360-300)*(360-320)+320;
